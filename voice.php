<?php
    ...
    $strResultArray = $objSoap->ConvertSimple( 'ffazio1@gmail.com', '4a8bfc4c6e', 'LoginKey', 'dae589c25cb576461aef', 'TTS_PAUL_DB', 'FORMAT_WAV', 16, 'The quick brown fox jumps over the lazy dog.' );
